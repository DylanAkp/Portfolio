...
import ContactInformations from 'src/components/ContactInformations.vue';
import SeparatorCat from 'src/components/SeparatorCat.vue';
import ProjectContainer from 'src/components/ProjectContainer.vue';
